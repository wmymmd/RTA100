...
Public Sub RunProc(iType As Integer)
    ...
    Select Case iType
        ...
        Case 1
'            ProcData(0) = Az2.intTemp1
'            ProcData(1) = Az2.intTime1
'            ProcData(2) = 1
'            ProcData(3) = 0
'            ProcData(4) = 1
'
'            ProcData(10) = Az2.intTemp2
'            ProcData(11) = Az2.intTime2
'            ProcData(12) = 1
'            ProcData(13) = 0
'            ProcData(14) = 1
...
ERRLINE:
    OpenTCP = False
    If mdlKernel.Az2_ConNum = 2 Then
    gbstrAlarmHint = " Az2 OpenTCP error"
    ShowAlarmFlash 1
    End If
End Function
...
Public Function ReadTC(Data() As Single) As Boolean
    ...
    If blnStopRead = True Then
        ReadTC = False
        Exit Function
    End If
        

    If ReadParas(101, Data(), True) Then
...
On Error GoTo ERRLINE:
    ...
    Exit Function
ERRLINE:
    gbstrAlarmHint = " Az2 ReadParas error"
    ShowAlarmFlash 1
    ReadParas = False
End Function
...
ERRLINE:
    WritePara = False
    gbstrAlarmHint = " Az2 WritePara error"
    ShowAlarmFlash 1
...
Public Function WriteParas(address As Long, Data() As Integer, IsWait As Boolean) As Boolean
    ...
    If wsReadPara.state = sckConnected Then
        ...
        blnGetPara = False
        Else
        WriteLog ("AZ2 Connect Error" + CStr(wsReadPara.state))
        GoTo ERRLINE:
    End If
...
ERRLINE:
    ...
    If IsInitAzbil = True Then
      If WriteErr_Count = 2 And Write_Result = False Then
        gbstrAlarmHint = " Az2 WriteParas error" + TCM2_WriteErrDetail
        WriteLog ("AZ2報錯:" & gbstrAlarmHint)
        ShowAlarmFlash 1
      End If
      Else
        gbstrAlarmHint = " Az2 WriteParas error"
        ShowAlarmFlash 1
    End If
    
'    WriteLog ("AZ2報錯-----Errcode: " & Err.Number & "  Description: " & Err.Description)
'    gbstrAlarmHint = " Az2 WriteParas error"
'    ShowAlarmFlash 1
'    WriteParas = False
...
Private Sub tmrSendStatus_Timer()
    ...
    If gbintAz2ProcNo = -1 Then
        Call ReadParas(101, Data(), False)
    Else
        Call frmAz2.RunProc(gbintAz2ProcNo)
        gbintAz2ProcNo = -1
    End If
    
    
'    Select Case gbintAz2ProcNo
'    Case -1
'        Call ReadParas(101, Data(), False)
'
'    Case 0
'        Call frmAz2.RunProc(0)
'        gbintAz2ProcNo = -1
'    Case 1
'        Call frmAz2.RunProc(1)
'        gbintAz2ProcNo = -1
'    Case 2
'        Call frmAz2.RunProc(2)
'        gbintAz2ProcNo = -1
'    Case Else
'        Call frmAz2.RunProc(gbintAz2ProcNo)
'        gbintAz2ProcNo = -1
